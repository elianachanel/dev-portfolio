...
export function HeroSection() {
  ...
  return (
    <section
      id="about"
      className="relative min-h-[min(100dvh,920px)] scroll-mt-28 pt-28 pb-16 sm:pt-32 sm:pb-20 lg:pt-36"
    >
      <motion.div
          ...
          >
            ...
            >
              <div className="relative grid size-[min(280px,78vw)] place-items-center">
                ...
                <motion.div
                  className="avatar-face-glow relative z-[1] size-[220px] overflow-hidden rounded-full border border-white/15 bg-zinc-900 ring-2 ring-sky-400/30 ring-offset-4 ring-offset-[#0a0a0c] sm:size-[260px]"
